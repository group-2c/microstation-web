...
export default {
  common: [
    ...
    { title: "微站控制器名称", dataIndex: "name", align: "left", width: 120, ellipsis: true },    
    { title: "微站控制器ID", dataIndex: "slaveId", align: "left", width: 120, ellipsis: true },
    { title: "设备名称", dataIndex: "baudRate", align: "left", width: 120 },
    { title: "设备ID", dataIndex: "baudRate", align: "left", width: 120 },
    { title: "设备地址", dataIndex: "baudRate", align: "left", width: 120 },
    { title: "波特率", dataIndex: "baudRate", align: "left", width: 120 },
    { title: "数据位", dataIndex: "baudRate", align: "left", width: 120 },
    { title: "停止位", dataIndex: "baudRate", align: "left", width: 120 },
    { title: "奇偶校验", dataIndex: "baudRate", align: "left", width: 120 },
    { title: "设备状态", dataIndex: "baudRate", align: "left", width: 120 },
  ],
